...
public class Solution2 {
    ...
    private void letterCombinationUtil(String combination, String digitString) {
...
//                String letter = letters.substring(i, i + 1);
            for (char ch : letters.toCharArray()) {
                ...
                letterCombinationUtil(combination + letter, digitString.substring(1));
            }
        }
    }

    public String letterCombination(int[] inputArray) {
        ...
        letterCombinationUtil("", digitString);
